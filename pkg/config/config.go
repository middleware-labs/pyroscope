...
type Server struct {
	...
	Retention          time.Duration   `def:"3h" desc:"sets the maximum amount of time the profiling data is stored for. Data before this threshold is deleted. Disabled by default" mapstructure:"retention"`
	...
	NoSelfProfiling   bool              `def:"true" desc:"disable profiling of pyroscope itself" mapstructure:"no-self-profiling"`
